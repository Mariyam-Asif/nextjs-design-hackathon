...
export default async function Hero() {
  ...
  return (
    <section aria-label="Hero section" className="relative w-full h-[65vh] sm:h-[75vh] lg:h-[88vh] min-h-[500px] max-h-[850px] overflow-hidden bg-gray-100">
      ...
      <div className="absolute top-1/2 -translate-y-1/2 left-4 right-4 sm:left-auto sm:right-8 lg:right-12 xl:right-16 bg-[#FFF3E3]/95 w-auto sm:w-[380px] md:w-[420px] lg:w-[450px] p-5 sm:p-6 lg:p-7 rounded-xl shadow-xl backdrop-blur-xs border border-[#F5E6D3] transition-all duration-300">
